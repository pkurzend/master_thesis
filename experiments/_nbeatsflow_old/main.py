...
positional_encoding = hp_dict['positional_encoding']
...
hp_dict['block'] = 'TimeAttentionNBeatsBlock'
...
plot1(targets, forecasts, modelpath, prediction_length, target_dim, plots_folder)
plot2(targets, forecasts, modelpath, prediction_length, target_dim, plots_folder)
